...
extern "C" {
  ...
  Java_com_example_jazz_objectdetection_Utils_CaffeInterface_detect(JNIEnv *env,
                                                                jobject instance,
                                                                jbyteArray jrgba,
                                                                jint jchannels,
                                                                jfloatArray jmean,
    ...
    if (!caffe_mobile->predictImage(rgba, jchannels, mean, im_info, ori_img_info, results)) {

...
namespace caffe {
  ...
  bool CaffeMobile::predictFasterRCNN(const uint8_t* rgba,
                                 int channels,
    ...
    LOG(INFO)<<"input_channels: "<<input_channels;
  ...
  bool CaffeMobile::predictSSD(const uint8_t* rgba,
                               const std::vector<float> &mean,
                               int ori_img_info[2],
                       ...
                       int ori_img_info[2])
  {
    LOG(INFO)<<"CLASS_NUM: "<<cls_num<<"   confidence: "<<confidence;
      ...
      LOG(INFO)<<"pred_boxes[0]: "<<pred_boxes[0]<<"   ori_img_info[1]: "<<ori_img_info[1];
      pred_boxes[0] *= ori_img_info[1];
      LOG(INFO)<<"pred_boxes[0]: "<<pred_boxes[0]<<"   ori_img_info[1]: "<<ori_img_info[1];
      pred_boxes[1] *= ori_img_info[0];
      pred_boxes[2] *= ori_img_info[1];
      pred_boxes[3] *= ori_img_info[0];
  ...
  void CaffeMobile::checkConfidence(vector<vector<float>> pred_boxes,
